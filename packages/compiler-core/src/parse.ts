// 将 template 解析为 AST 抽象语法树的操作文件，见 Vue.js设计与实现 第十六章 解析器
...
function parseTag(
  ...
  if (
    ...
    // 重新解析 attrs 和过滤出自身不是 v-pre 的 attrs
